...
function Game (){
  this.canvas = document.getElementById('canvasGame'); // find this id
  this.canvasContext = this.canvas.getContext ('2d'); // here paint
  this.FPS = 60;     // frame in sec
  this.ballX = this.canvas.width / 2;  // start sharika
  this.ballY = this.canvas.height - 20;  // start
  this.ballSpeedX = 2;                   // v
  this.ballSpeedY = 4;
  this.PADDLE__WIDTH = 75;       // pryamougol
  this.PADDLE__HEIGHT = 10;
  this.paddleX = (this.canvas.width - this.PADDLE__WIDTH) / 2;   // center position
